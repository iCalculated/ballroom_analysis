...
# %% auto 0
__all__ = ['event_names', 'o2cm_cache', 'pickle_file', 'headers', 'name', 'soup', 'events', 'Style', 'Event', 'parse_event_name',
...
o2cm_cache = {}
pickle_file = "o2cm_cache.pkl"
if os.path.exists(pickle_file):
    try:
        o2cm_cache = load(open(pickle_file, "rb"))
...
def get_event_list_html(name: str) -> BeautifulSoup:
    ...
    if log2(len(o2cm_cache)).is_integer():
        dump(o2cm_cache, open(pickle_file, "wb"))
    return soup
...
def get_event_result(name: str, url: str, o2cm_cache=o2cm_cache) -> Result:
    ...
    if url in o2cm_cache:
        ...
        o2cm_cache[url] = soup
        if log2(len(o2cm_cache)).is_integer():
            dump(o2cm_cache, open("o2cm_cache.pkl", "wb"))
