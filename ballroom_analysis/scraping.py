...
# %% auto 0
__all__ = ['CORRECTIONS_PICKLE', 'event_metadata', 'event_names', 'o2cm_cache', 'CACHE_PICKLE', 'headers', 'name', 'soup',
...
class Event(NamedTuple):
    ...
    def __str__(self):
        return f"{self.division} {self.level} {self.dances} {str(self.style)}"
